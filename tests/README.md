...
The smoke test uses an isolated Edge profile and verifies registry rendering, page migration, insertion, undo, security allowlists, validation, publication, dark mode, coupons, mobile navigation and the public lead flow.
