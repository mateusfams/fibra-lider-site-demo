...
The smoke test uses an isolated Edge profile and verifies registry rendering, page migration, insertion, undo, live preview, Hero banner/slider modes, slide editing, responsive media, computed alignment, security allowlists, validation, publication, dark mode, coupons, the manual WhatsApp campaign audience, mobile navigation and the public lead flow.
